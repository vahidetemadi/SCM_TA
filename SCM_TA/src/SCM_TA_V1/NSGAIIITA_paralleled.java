...
import javax.swing.JFrame;
	public class NSGAIIITA_paralleled implements Problem, Serializable{
	...
	public void evaluate(Solution solution){
		...
		for(ArrayList<Integer> sche:solution.getSchedules()){
			System.out.println(GA_Problem_Parameter.DEP.vertexSet().size());
	...
	public int getNumberOfVariables() {
		// TODO Auto-generated method stub
		return GA_Problem_Parameter.setNum_of_Variables(GA_Problem_Parameter.bugs);
	}
	...
	public int getNumberOfObjectives() {
		// TODO Auto-generated method stub
		return GA_Problem_Parameter.Num_of_functions_Multi;
	}
